...
> “Enfoque sistemático, integral y holístico para estructurar información de manera que sea fácil de encontrar y comprender independiente del contexto, canal o medio que el usuario emplea para acceder a ella”.
...
Usa etiquetas cortas que reflejan lo que hará el usuario, es decir, lenguaje imperativo.
...
Con la clasificación de tarjetas salen:
+ Categoría
+ Muestras de contenido

Tarjetas de clasificación vía herramientas IA:
- UserZoom https://www.userzoom.com/
- usabiliTEST https://www.usabilitest.com/CardSorting
- xSort https://xsortapp.com/
- Óptima clasificación. https://www.optimalworkshop.com/optimalsort

Un estudio de caso de IA: https://bit.ly/369HQDR
...
*Navegación*
-
Cuando trabaje en la navegación, recuerde que no importa de qué páginas provengan los visitantes, deben poder encontrar lo que necesitan. Un sistema de navegación consta de muchos elementos: botones, menús y tablas de contenido. Hay cuatro tipos principales:
+ Jerárquico: muestra la jerarquía de información de los elementos principales a sus subcategorías. Un ejemplo son los menús desplegables para sitios web grandes.
+ Global o en todo el sitio: presente en todas las páginas, está navegación permite a los usuarios acceder a la página principal desde cualquier ubicación, por ejemplo, menús fijos, pie de página o hamburguesas a la izquierda o derecha, centrados en la parte superior.
+ Local: muestra la navegación de un área específica: una página o parte de un sitio y su contenido. Puede estar presente en forma de listas.
+ Contextual: se relaciona con contenido específico, como documentos, páginas, objetos de audio y video o productos relacionados. Recuerde hacer un logotipo en el que se pueda hacer clic que dirija a un usuario directamente a una página de inicio.
-
*Etiquetado*
-
La etiqueta correcta brinda a los usuarios una conceptualización adecuada de la categoría con la que están tratando. Durante este procedimiento, nombre todas las partes de IA con encabezados y subtítulos. El propósito de las etiquetas es atraer la atención del usuario, proporcionando una comprensión adecuada de qué esperar al hacer clic en un enlace. Los ejemplos son la mejor descripción, así que ilustra tus etiquetas.
-
*Mapas mentales*
-
El mapeo mental es una técnica basada en las relaciones entre diferentes páginas de un producto digital con una descripción detallada de la funcionalidad.
-
Patrones de diseño
-
El patrón de diseño es una forma de estructurar el contenido. Le permite elegir la dirección al comienzo de las actividades de rediseño de sitios web o de construcción de IA. Hay varios patrones de diseño de IA, que describimos a continuación:
- Modelo de página única
- Estructura plana
- Patrón de páginas de índice
- Patrón de jerarquía estricta
- Patrón de jerarquías coexistentes
-
Mapa del sitio
-
